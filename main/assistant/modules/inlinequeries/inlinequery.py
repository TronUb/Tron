    ...
    if query.startswith("#pmpermit"):
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                description="""This is tron security system,
                    it helps you to stop spammers from spamming in your dm.
                    """,
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                caption="""**Dex:** Home\n\n
                    **Description:** This is your helpdex use this to navigate in different sub dex. 
                    guidence and information is given in each dex.
                    """,
                parse_mode=ParseMode.DEFAULT,
                reply_markup=InlineKeyboardMarkup(
                    [
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                title="Inline alive",
                description="""This is same as alive command.
                    the difference is that this command have inline button.
                    """,
