...
@app.on_cmd(
    commands="vsubclip",
    usage="Cut a subclip of a video.",
    disable_for=UserType.SUDO
)
...
@app.on_cmd(
    commands="vafadein",
    usage="Add fade in transition to audio of video.",
    disable_for=UserType.SUDO
)
...
@app.on_cmd(
    commands="vafadeout",
    usage="Add fade out transition to audio of video.",
    disable_for=UserType.SUDO
)
...
@app.on_cmd(
    commands="vsetaudio",
    usage="Set a new audio to video.",
    disable_for=UserType.SUDO
)
...
@app.on_cmd(
    commands="vspeed",
    usage="Increase/Decrease video speed.",
    disable_for=UserType.SUDO
)
...
@app.on_cmd(
    commands="vfadeout",
    usage="Fadeout transition to video.",
    disable_for=UserType.SUDO
)
...
@app.on_cmd(
    commands="vfadein",
    usage="Fadein transition to video.",
    disable_for=UserType.SUDO
)
